...
import mid1.exception.example.version4.exception.ConnectException;
import mid1.exception.example.version4.exception.SendException;
...
public class NetworkClientV5 implements AutoCloseable{
    ...
    @Override
    public void close() { // try 가 끝나면 자동으로 호출
        
        // 종료 시점에 자원 반납하는 로직을 정의하면 됨
        System.out.println("NetworkClientV5 auto close");
        disconnect();
    }
}
